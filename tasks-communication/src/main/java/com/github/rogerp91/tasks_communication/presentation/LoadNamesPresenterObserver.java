 ...
 */
public class LoadNamesPresenterObserver extends DisposableObserver<List<NamesDto>> {

    private final NamesPresenter namesPresenter;

    public LoadNamesPresenterObserver(NamesPresenter namesPresenter) {
    ...
    public void onError(Throwable e) {
        if (e != null){
            namesPresenter.getView().showError();
        }
